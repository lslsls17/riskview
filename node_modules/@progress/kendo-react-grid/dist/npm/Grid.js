...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.render = function () {
            ...
            return {
                row: _this._columns.map(function (column, index) {
                    ...
                    return currentColumnIsInEdit ?
                        React.createElement(GridEditCell_1.GridEditCell, __assign({ key: index }, cellProps)) :
                        React.createElement(GridCell_1.GridCell, __assign({ key: index }, cellProps));
                }),
                isInEdit: isInEdit
            };
        };
        ...
        var pager = this.props.pageable && (React.createElement(kendo_react_data_tools_1.Pager, __assign({ className: "k-grid-pager", onPageChange: this.pageChange, total: total, skip: this.vs.propsSkip || 0, take: (this.props.take !== undefined ? this.props.take : this.props.pageSize) || 10, messagesMap: messages_1.pagerMessagesMap }, (GridPagerSettings_1.normalize(this.props.pageable)))));
        ...
        if (this.props.scrollable === 'none') {
            return (React.createElement("div", { style: this.props.style, className: kendo_react_common_1.classNames('k-widget k-grid', this.props.className), ref: function (el) { _this.element = el; } },
                toolbar,
                groupingPanel,
        ...
        return (React.createElement("div", { style: wrapperStyle, className: kendo_react_common_1.classNames('k-widget k-grid', {
